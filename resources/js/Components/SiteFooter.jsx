                    ...
                    <div className="lg:col-span-1 flex flex-col justify-between">
                        ...
                        <div className="flex gap-4">
                            <a
                                ...
                                className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] shadow-xl transition-all duration-300 hover:scale-110 hover:shadow-2xl active:scale-95"
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1877F2] shadow-xl transition-all duration-300 hover:scale-110 hover:shadow-2xl active:scale-95"
