     ...
     <div class="swiper-slide">
         <div class="time_line_box"> 
            <div class="time_inner"> 
                <div class="border_liner"> <span></span>
                 <span class="last"></span> </div> <div class="content">
                     <<?php echo esc_attr($settings['title_tag']); ?> class="t_title"> <a href="<?php echo esc_url($timeline_content['link_box']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>> <?php echo wp_kses($timeline_content['timeline_heading'] , $allowed_tags); ?> </a>
                     </<?php echo esc_attr($settings['title_tag']); ?>> <p> <?php echo wp_kses($timeline_content['timeline_description'] , $allowed_tags); ?></p>
                     </div> 
                     <div class="year"> 
                        <?php echo wp_kses($timeline_content['timeline_date'] , $allowed_tags); ?>
                    </div> <?php if(!empty($timeline_content['image']['url'])): $image = isset($timeline_content['image']['alt']) ? $timeline_content['image']['alt'] : ''; if(!empty($image)) { $image = $image; }else{ $image = 'image'; } ?> <div class="image"> <img src="<?php echo esc_url($timeline_content['image']['url']); ?>" alt="<?php echo esc_attr($image); ?>" /> </div> <?php endif; ?> </div> </div> </div> <?php endif; ?> <?php endforeach; ?> </div> </div> <?php if($settings['arrow_enable'] == 'yes'): ?>
                         <div class="position-relative"> <div class="next-single-one_three"> </div> <div class="prev-single-one_three"> </div> </div> <?php endif; ?></section>
<?php
}
}
