                        ...
                        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                            <div>
                                ...
                                <div className="flex gap-3 mb-8">
                                    {[1, 2, 3, 4].map((i) => (
                                        <div key={i} className="w-16 h-16 md:w-20 md:h-20 rounded-lg overflow-hidden border border-slate-200 shadow-sm">
                                            <img src={asset(`/images/projects/p${i}.png`)} alt={`Usage ${i}`} className="w-full h-full object-cover" />
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className="mb-10">
                                    ...
                                    <p className="text-3xl font-bold text-slate-800">1500 - 2500 Ltr/ Day</p>
                                </div>
                            ...
                            <div className="relative flex justify-center lg:justify-end">
                                ...
                                <div className="relative bg-slate-100/50 rounded-full p-10 md:p-20 border border-slate-200/50 backdrop-blur-sm shadow-inner">
                                    <img
                                        src={asset('/images/product-wtp.jpg')}
                                        alt="Standard Series Plant"
                                        className="w-[280px] md:w-[420px] h-auto drop-shadow-2xl transition-transform duration-700 hover:scale-105 saturate-50"
                                    />
                                </div>
                            </div>
                        </div>
