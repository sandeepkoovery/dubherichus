   ...
   class Widget_creote_header_v8 extends Widget_Base
   {
       ...
       $this->add_responsive_control(
           ...
           [
             ...
             'default' => 'absolute',
             'selectors' => [
               '{{WRAPPER}} .header.style_seven.style_eight  ' => 'position: {{VALUE}}; width:100%;',
            ],
           ]
       );
       $this->add_responsive_control(
