                        ...
                        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                            <div>
                                ...
                                <div className="mb-10">
                                    ...
                                    <p className="text-3xl font-semibold text-slate-800">800 - 1200 Ltr/ Day</p>
                                </div>
                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            {[
                                ...
                                <div key={i} className="p-8 bg-slate-50 rounded-[28px] border border-slate-100 hover:border-blue-200 hover:shadow-xl transition-all group">
                                    ...
                                    <h4 className="text-xl font-semibold tracking-tight mb-3 text-slate-900">{item.title}</h4>
